    ...
    description: (
      <div className="space-y-2">
        ...
        <ul className="list-disc list-inside space-y-1">
          <li>
            Implemented TCP socket handling and event-driven concurrency using
            epoll.
          </li>
          <li>Built manual HTTP request parsing for GET and POST methods.</li>
          <li>
            Implemented header parsing, response generation, and static file
            serving.
          </li>
          <li>
        ...
        <div>
          <h3 className="text-lg font-semibold text-highlight mb-2">Links</h3>
...

  {
    ...
    description: (
      <div className="space-y-2">
        ...
        <ul className="list-disc list-inside space-y-1">
          <li>
            Automated resume parsing and structured data extraction from PDFs.
          </li>
    ...
    imageLight: "/projects/portly.png",
...

  {
    ...
    description: (
      <div className="space-y-2">
        ...
        <ul className="list-disc list-inside space-y-1">
          <li>
            Built a retrieval-based document generation pipeline using RAG
            architecture.
          </li>
          <li>Implemented a clause risk analysis engine using LLM APIs.</li>
          <li>Enabled exporting generated documents as PDFs.</li>
          <li>
            Designed contextual generation using MongoDB retrieval pipelines.
          </li>
        </ul>
        <div>
          <h3 className="text-lg font-semibold text-highlight mb-2">Links</h3>
          <div className="flex gap-4">
            ...
            <a
            href="https://lex-gen-ai.vercel.app/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-accent hover:underline"
            >
    ...
    description: (
      <div className="space-y-2">
        <p>
          ...
          guidance through phone calls using telephony integration and
          retrieval.
        </p>
        <ul className="list-disc list-inside space-y-1">
          <li>Built voice interaction through Twilio telephony integration.</li>
          <li>
            Implemented BM25 retrieval engine for agricultural knowledge
            queries.
          </li>
          <li>
            Designed for real-time query responses for non-technical rural
            users.
          </li>
          <li>
            Integrated speech models for voice-to-text and text-to-speech.
          </li>
        </ul>
        <div>
          <h3 className="text-lg font-semibold text-highlight mb-2">Links</h3>
          <div className="flex gap-4">
            <a
              href="https://github.com/Aryan9inja/Krishi-Setu"
              target="_blank"
              rel="noopener noreferrer"
              className="text-accent hover:underline"
            >
            ...
            <a
              href="https://youtu.be/o92L3jVlEbw"
              target="_blank"
              rel="noopener noreferrer"
              className="text-accent hover:underline"
            >
...

  {
    ...
    description: (
      <div className="space-y-2">
        ...
        <ul className="list-disc list-inside space-y-1">
          <li>
            Implemented OCR-based receipt parsing with GPT-powered structured
            data extraction.
          </li>
          <li>
          ...
          <li>
            Optimized database queries and backend architecture for efficient
            data retrieval.
          </li>
        </ul>
        <div>
...

  {
    ...
    description: (
      <div className="space-y-2">
        ...
        <ul className="list-disc list-inside space-y-1">
          <li>
            Secure authentication with JWT and full CRUD for notes and tasks.
          </li>
...

  {
    ...
    description: (
      <div className="space-y-2">
        ...
        <ul className="list-disc list-inside space-y-1">
          <li>
            Built real-time chat using WebSockets supporting concurrent users.
          </li>
          ...
          <li>
            Microservice-style backend with NestJS for scalable architecture.
          </li>
        </ul>
        <div>
          <h3 className="text-lg font-semibold text-highlight mb-2">Links</h3>
